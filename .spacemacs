...
values."
  (setq-default
   ...
   '(
     yaml
     (ruby :variables ruby-enable-enh-ruby-mode t ruby-version-manager 'rbenv ruby-test-runner 'minitest)
     clojure
     ;; ----------------------------------------------------------------
